...
public class Employee {
	...
	private Integer empl_luuser;// int
	...
	public Employee(Integer empl_id, String empl_frstname, String empl_lastname, String empl_surname,
			...
			String empl_fname, Date empl_luudate, Integer empl_luuser) {
	...
	public void setEmpl_luuser(int empl_luuser) {
		this.empl_luuser = empl_luuser;
	}

	public int getEmpl_luuser() {
		return empl_luuser;
	}
	...
	public String toString() {
		return "Employee{" + "empl_id=" + empl_id + ", empl_frstname='" + empl_frstname + '\'' + ", empl_lastname='"
				...
				+ ", empl_luudate=" + empl_luudate + ", empl_luuser=" + empl_luuser + empl_luuser + '}';
